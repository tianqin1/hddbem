A prototype program that apply the hierarchical domain decomposition boundary element method (HDD-BEM) into the multi-group neutron diffusion equation and sp3 equation in 1-D geometry.
